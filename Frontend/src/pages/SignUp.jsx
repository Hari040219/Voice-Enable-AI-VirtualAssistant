...
>
  ...
  >
    <h1 className="text-white text-[32px] font-bold mb-[30px] tracking-wide">
      Register to <span className="text-blue-400 drop-shadow-md">Virtual Assistant</span>
    </h1>
    ...
    <button 
      className="min-w-[150px] h-[55px] mt-[25px] text-white font-semibold bg-gradient-to-r from-green-500 to-blue-500 hover:from-blue-600 hover:to-green-600 rounded-xl text-[18px] shadow-md hover:shadow-lg transition-all duration-300 disabled:opacity-50" 
      disabled={loading}
    >
